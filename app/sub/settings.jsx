        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View className="bg-white rounded-3xl mx-5 p-6 mt-3 mb-10 shadow w-[374px] self-center">
                ...
                <View className="mt-2 space-y-4">
                    ...
                    <Text className="text-gray-600 mt-1">Vaibhav Mistry</Text>
                    </View>

                    {/* Email */}
                    <View className="bg-[#f4f8ff] rounded-2xl p-4 mt-3">
                    <Text className="text-[16px] font-semibold text-gray-800">Email</Text>
                    <Text className="text-gray-600 mt-1">info@webyuginfonet.com</Text>
                    </View>

                    {/* Phone */}
                    <View className="bg-[#f4f8ff] rounded-2xl p-4 mt-3">
                    <Text className="text-[16px] font-semibold text-gray-800">Phone Number</Text>
                    <Text className="text-gray-600 mt-1">+91 98765 43210</Text>
                    </View>
                ...
                <TouchableOpacity
                    ...
                    className={`flex-row items-center justify-between py-4 rounded-xl  ${
                    openSection === "Notifications" ? "bg-[#]" : ""
                    }`}
                >
                    <View className="flex-row items-center">
                    <Ionicons
                    ...
                    <Feather
                    name={
                        openSection === "Notifications" ? "chevron-up" : "chevron-down"
                    }
                    size={20}
                    color={openSection === "Notifications" ? "#4f8bff" : "#606b80"}
                    />
